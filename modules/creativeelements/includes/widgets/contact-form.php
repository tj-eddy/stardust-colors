    ...
    protected function _registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'link' => [
                    'url' => $this->getModuleLink('contactform'),
                    'is_external' => true,
                ],
                'separator' => 'before',
            ]
    ...
    protected function render()
    {
        ...
        <form class="elementor-contact-form" <?php $this->printRenderAttributeString('form'); ?>>
            ...
            <?php } else { ?>
                ...
                <?php } ?>
                    <div class="elementor-select-wrapper">
                        <select name="id_contact" id="id-contact-<?php echo $id; ?>" class="<?php echo $input_classes; ?> elementor-field-textual">
            ...
            <?php } ?>
                ...
                <?php } ?>
                    <input type="email" name="from" <?php $this->printRenderAttributeString('email'); ?> class="<?php echo $input_classes; ?> elementor-field-textual" required>
                </div>
            <?php if ($settings['show_reference'] && (Plugin::$instance->editor->isEditMode() || $orders)) { ?>
                ...
                <?php } ?>
                    <div class="elementor-select-wrapper">
                        <select name="id_order" id="id-order-<?php echo $id; ?>" class="<?php echo $input_classes; ?> elementor-field-textual">
                        <?php if (!$id_order) { ?>
            ...
            <?php } ?>
                ...
                <?php } ?>
                    <textarea name="message" <?php $this->printRenderAttributeString('message'); ?> class="<?php echo $input_classes; ?> elementor-field-textual" required></textarea>
                </div>
            <?php if ($this->gdpr) { ?>
