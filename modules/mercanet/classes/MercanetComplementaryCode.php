...
class MercanetComplementaryCode extends ObjectModel
{
    /**
     * ID
     * @var integer
    ...
    public static $definition = array(
        'table' => 'mercanet_complementary_code',
        'primary' => 'id_mercanet_complementary_code',
        'multilang' => true,
        'fields' => array(
    ...
    public static function getMessageByCode($code, $id_lang = null)
    {
        ...
        return Db::getInstance()->getValue('
			SELECT `message`
			FROM `'._DB_PREFIX_.'mercanet_complementary_code_lang`
			WHERE `id_lang` = '.pSQL((int)$id_lang).'
			AND `id_mercanet_complementary_code` = "'.pSQL($code).'"
		');
    }
}
