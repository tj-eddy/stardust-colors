...
<div>
    ...
    <p>
        <a href="javascript:void(0)" onclick="document.getElementById('mercanet_form').submit();">
            {l s='Please click here if you are not automatically redirected.' mod='mercanet'}
        </a>
    </p>
    <form id="mercanet_form" method="POST" action="{$url|escape:'htmlall':'UTF-8'}">
