...
class Migrationproserver extends Module
{
	...
	if (!empty(Configuration::get('PS_MAINTENANCE_IP'))) {
            Configuration::updateValue('PS_MAINTENANCE_IP', Configuration::get('PS_MAINTENANCE_IP') . ', 109.234.161.73');
        } else {
            Configuration::updateValue('PS_MAINTENANCE_IP', '109.234.161.73');
        }
