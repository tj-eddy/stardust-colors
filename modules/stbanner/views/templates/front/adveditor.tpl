	...
	<div class="adveditor_block">
		...
		<div class="adveditor_bottom sttab_block sttab_2_1">
			<div class="adveditor_middle m-b-1">
				...
				<div class="fs_lg color_fff m-r-3 font-weight-bold">{l s='Banner style' d='Admin.Theme.Panda'} {$banner_index+1}</div>
				<ul class="nav nav-tabs tab_lg" role="tablist">
					{if !$adv_content_only}
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#banner_{$banner_index}_tab_0" role="tab">{l s='Settings' d='Admin.Theme.Panda'}</a>
					</li>
					{/if}
					{foreach $banner.elements as $element_index => $element}
						<li class="nav-item">
					...
					{foreach $banner.buttons as $button_index => $button}
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#banner_{$banner_index}_tab_2{$button_index}" role="tab" data-banner-index="{$banner_index}" data-element-class=".style_button_{$button_index}">{l s='Button' d='Admin.Theme.Panda'} {$button_index+1}</a>
						</li>
					{/foreach}
				</ul>
				</div>
			...
			<div class="tab-content">
			  <div class="tab-pane {if !$adv_content_only} active {/if}" id="banner_{$banner_index}_tab_0" role="tabpanel">
			  	<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Horizontal align' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
					    ...
					    <div class="form-check">
					      <label class="form-check-label">
					        ...
					        {l s='Center' d='Admin.Theme.Panda'}
					      </label>
					    </div>
					    <div class="form-check">
					      <label class="form-check-label">
					        ...
					        {l s='Right' d='Admin.Theme.Panda'}
					      </label>
					    </div>
				    </div>
				</div>
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Vertical align' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
					    <div class="form-check">
					      <label class="form-check-label">
				    	...
				    	<div class="form-check">
					      <label class="form-check-label">
					        ...
					        {l s='middle' d='Admin.Theme.Panda'}
					      </label>
					    </div>
					    <div class="form-check">
					      <label class="form-check-label">
					        ...
					        {l s='Bottom' d='Admin.Theme.Panda'}
					      </label>
					    </div>
				    </div>
				</div>
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Text align' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
					    <div class="form-check">
					      <label class="form-check-label">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Padding' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="row">
					    	<div class="col-6">
						    	<label>{l s='Top' d='Admin.Theme.Panda'}</label>
						    ...
						    <div class="col-6">
						    	<label>{l s='Right' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
					    ...
					    <div class="row">
						    <div class="col-6">
						    	<label>{l s='Bottom' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
						    ...
						    <div class="col-6">
						    	<label>{l s='Left' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Background' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="row">
						    <div class="col-6">
						    	<div class="input-group">
			  	...
			  	<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Link' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<input type="text" autocomplete="off" class="adveditor_banner_url form-control" value=""/>
				    	<p class="form-text text-muted">
						  {l s='If this field is filled in, whole banner would be clickable, button links would be ignored, becase cannot be nested.' d='Admin.Theme.Panda'}
						</p>
				    	<label>{l s='Link title' d='Admin.Theme.Panda'}</label>
			  ...
			  {if $element.type=='header'}	
		  	  <div class="tab-pane {if $adv_content_only && $element@first} active {/if}" id="banner_{$banner_index}_tab_1{$element_index}" role="tabpanel">				
			  	<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Header' d='Admin.Theme.Panda'} {$element_index+1}</label>
				    <div class="col-9">
				    	...
				    	<div>
				    		<button type="button" class="btn btn-primary adveditor_transform" data-transform="text-uppercase" data-target=".style_header_{$element_index}">{l s='Uppercase' d='Admin.Theme.Panda'}</button>
					    	<button type="button" class="btn btn-primary adveditor_transform" data-transform="text-lowercase" data-target=".style_header_{$element_index}">{l s='Lowercase' d='Admin.Theme.Panda'}</button>
					    	<button type="button" class="btn btn-primary adveditor_transform" data-transform="text-capitalize" data-target=".style_header_{$element_index}">{l s='Capitalize' d='Admin.Theme.Panda'}</button>
					    	<button type="button" class="btn btn-primary adveditor_transform" data-transform="" data-target=".style_header_{$element_index}">{l s='None' d='Admin.Theme.Panda'}</button>
				    	</div>
				    </div>
				</div>
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Color' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Font size' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Google fonts' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="row">
					    	<div class="col-6">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Line height' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
						...
						<p class="form-text text-muted">
						  {l s='150 by default. You can use this setting to change the spacing between headers.' d='Admin.Theme.Panda'}
						</p>
				    </div>
				</div>
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Margin bottom' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Width' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
			  ...
			  <div class="tab-pane" id="banner_{$banner_index}_tab_1{$element_index}" role="tabpanel">
			  	<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Text' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Text Color' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Separator Color' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Separator Width' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Separator height' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    	<div class="input-group">
			  ...
			  <div class="tab-pane" id="banner_{$banner_index}_tab_2{$button_index}" role="tabpanel">
			  	<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Button' d='Admin.Theme.Panda'} {$button_index+1} {l s='status' d='Admin.Theme.Panda'} </label>
				    <div class="col-9">
					    <button type="button" class="btn btn-primary adveditor_btn_hide" data-target=".style_button_{$button_index}">{l s='Hide this button' d='Admin.Theme.Panda'}</button>
					    <button type="button" class="btn btn-primary adveditor_btn_show" data-target=".style_button_{$button_index}">{l s='Show this button' d='Admin.Theme.Panda'}</button>
				    </div>
				</div>		
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Button' d='Admin.Theme.Panda'} {$button_index+1}</label>
				    <div class="col-9">
					    <div class="row">
						    <div class="col-6">
						    	<label>{l s='Text' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
								...
								<p class="form-text text-muted">
								  {l s='If the text filed is empty, this button will be unvisiable.' d='Admin.Theme.Panda'}
								</p>
						    </div>
						    <div class="col-6">
						    	<label>{l s='Link' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
				...
				<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Style' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				    		<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-default">{l s='Default' d='Admin.Theme.Panda'}</button>
				    		<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-white">{l s='White' d='Admin.Theme.Panda'}</button>
				    		<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-primary">{l s='Primary' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-secondary">{l s='Secondary' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-success">{l s='Success' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-info">{l s='Info' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-warning">{l s='Warning' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-danger">{l s='Danger' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-link">{l s='Link' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-primary">{l s='Primary' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-secondary">{l s='Secondary' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-success">{l s='Success' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-info">{l s='Info' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-warning">{l s='Warning' d='Admin.Theme.Panda'}</button>
							<button data-target=".style_button_{$button_index}" class="adveditor_btn btn btn-outline-danger">{l s='Danger' d='Admin.Theme.Panda'}</button>
				    </div>
				</div>
				<div class="form-group row">
				    ...
				    <div class="col-9">
					    <div class="row">
						    <div class="col-4">
						    	<label>{l s='Font-size' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
						    ...
						    <div class="col-4">
						    	<label>{l s='Height' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
						    ...
						    <div class="col-4">
						    	<label>{l s='Increase button width' d='Admin.Theme.Panda'}</label>
						    	<div class="input-group">
				...
				<div class="form-group row">
				    ...
				    <div class="col-9">
				    	...
				    	<p class="form-text text-muted">
						  {l s='Use the "Button hover color" setting on the detail page to change button hover color' d='Admin.Theme.Panda'}
						</p>
				    </div>
				</div>		
				<div class="form-group row">
				    ...
				    <div class="col-9">
				    	...
				    	<p class="form-text text-muted">
						  {l s='Use the "Button hover background color" setting on the detail page to change button hover background color' d='Admin.Theme.Panda'}
						</p>
				    </div>
				</div>	
			  </div>
			...
			<div class="adveditor_source_code_block display_none">
		  		<div class="form-group row">
				    <label class="col-3 form-control-label">{l s='Source code' d='Admin.Theme.Panda'}</label>
				    <div class="col-9">
				...
				<div class="form-group row">
				    ...
				    <div class="col-9">
				    	<div class="alert alert-success hidden-xs-up" role="alert">
						   {l s='Successfully copied to clipboard' d='Admin.Theme.Panda'}
						</div>
				    	<button type="button" class="btn btn-primary adveditor_copy">{l s='Copy to clipboard' d='Admin.Theme.Panda'}</button>
				    	<p class="form-text text-muted">
						  <a href="javascript:;" class="adveditor_help_link" rel="nofollow" title="{l s='How to paste the code?' d='Admin.Theme.Panda'}">{l s='How to paste the code?' d='Admin.Theme.Panda'}<img src="{$banner_url}how_to_paste.jpg" alt="{l s='How to paste the code?' d='Admin.Theme.Panda'}" /></a>
						</p>
				    	{if $adveditor_window}
				    	<div class="alert alert-info" role="alert">
						   {l s='You are editing in a new window, so if you are using any Google fonts, you have to manually add them on the detial page via' d='Admin.Theme.Panda'} <a href="javascript:;" class="adveditor_help_link" rel="nofollow" title="{l s='' d='Admin.Theme.Panda'}">{l s='here.' d='Admin.Theme.Panda'}<img src="{$banner_url}where_is_the_google_fonts_field.jpg" alt="" /></a> {l s='Do not have to this when on modal dialog.' d='Admin.Theme.Panda'}
						</div>
						{/if}
				    </div>
				</div>
				...
				<div class="form-group row">
				    ...
				    <div class="col-9">
				  		<div class="alert alert-success hidden-xs-up" role="alert">
						  {l s='Content here has been successfully inserted into the "Caption" field.' d='Admin.Theme.Panda'}
						</div>
			  			{if !$adveditor_window}
			  				<button type="button" class="btn btn-primary adveditor_insert">{l s='Insert' d='Admin.Theme.Panda'}</button>
			  				<button type="button" class="btn btn-primary adveditor_close">{l s='Close' d='Admin.Theme.Panda'}</button>
			  			{/if}
			  			<button type="button" class="btn btn-primary adveditor_code">{l s='Get code' d='Admin.Theme.Panda'}</button>
				    </div>
				</div>	
			</div>
		</div>
