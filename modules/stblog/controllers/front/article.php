...
class StblogArticleModuleFrontController extends StblogModuleFrontController
{
    ...
    public function init()
	{
        ...
        if (!Tools::getValue('preview') && !Tools::getValue('steasybuilder') && (!Validate::isLoadedObject($this->blog) || !$this->blog->active || !$this->blog->isAssociatedToShop()))
		{
            Tools::redirect('index.php?controller=404');
		}
    }
	public function initContent()
	{
        ...
        if(!$this->errors)
		{
            ...
            if (!empty($filteredCmsContent['object'])) {
                $blog = $filteredCmsContent['object'];
            }
