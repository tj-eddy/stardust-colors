...
{       
	public function initContent()
	{
        ...
        if (Configuration::get('ST_BLOG_SHOW_ALL')) {
            ...
            $soby = (int)Configuration::get('ST_BLOG_HOME_SORT_BY');
            switch($soby)
            {
                case 1:
                    $order_by = 'date_add';
    		...
    		$blogs = StBlogClass::getBlogs((int)$this->page, (int)$this->resultsPerPage, $order_by, $order_way);
    ...
    {
        return $this->context->link->getModuleLink('stblog', 'default', array());
    }
}