...
<div class="block_blog {if isset($classname)} {$classname} {/if}">
    ...
    <div class="pro_second_box pro_block_align_{$stblog.blog_block_align}">
        ...
        <div class="blog_info">
            ...
            {if $stblog.display_comment_count && isset($blog.comment_counter) && $blog.comment_counter}<a href="{$blog.link}#comments" title="{$blog.comment_counter} {if $blog.comment_counter>1}{l s='Comments' d='Shop.Theme.Panda'}{else}{l s='Comment' d='Shop.Theme.Panda'}{/if}"><i class="fto-chat-1 mar_r4"></i>{$blog.comment_counter}</a>{/if}
        ...
        {/if}
        {if $stblog.display_read_more}<a href="{$blog.link}" title="{l s='Read more' d='Shop.Theme.Panda'}" class="{if $stblog.display_read_more==2} go inline_block {else}btn btn-default{/if} mar_b6">{l s='Read more' d='Shop.Theme.Panda'}</a>{/if}
