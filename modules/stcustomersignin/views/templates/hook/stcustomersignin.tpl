...
{if $logged}
		...
		{else}
			<a href="{$my_account_url}" title="{l s='View my customer account' d='Shop.Theme.Panda'}" class="my_account_link top_bar_item" rel="nofollow"><span class="header_item my-account-cls"><i class="fto-user-1 mar_r4 fs_lg"></i>{l s='My account' d='Shop.Theme.Panda'}</span></a>
		{/if}
{else}
