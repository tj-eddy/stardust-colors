...
<div class="sttext_banner_{$element['st_el_text_banner']} {if $pre_template[1]==2 || $pre_template[1]==3} flex_container flex_column_md {/if} {if $pre_template[1]==3} flex_center {/if}">
    <div class="sttext_banner_text text-{$element.st_el_text_align} {if isset($element.st_el_mobile_text_align)} text-md-{$element.st_el_mobile_text_align} {/if} {if $pre_template[1]==2} flex_child {/if} {if $pre_template[1]==2 || $pre_template[1]==3} m-r-1 {/if}">
