...
{if !isset($sub_column.st_s_speed) || !$sub_column.st_s_speed}{$sub_column.st_s_speed=7000}{/if}
{if !isset($sub_column.st_a_speed) || !$sub_column.st_a_speed}{$sub_column.st_a_speed=400}{/if}
{if !isset($sub_column.st_slideshow)}{$sub_column.st_slideshow=0}{/if}
...
<section id="textboxes_{$sub_column.id_st_easy_content_column}" class="textboxes_container static_bullets" >
    ...
    {else}
        ...
        is_product_slider=0
        slider_s_speed=$sub_column.st_s_speed
        slider_slideshow=$sub_column.st_slideshow
        slider_a_speed=$sub_column.st_a_speed
