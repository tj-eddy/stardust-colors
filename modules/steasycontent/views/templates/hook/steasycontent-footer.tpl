...
{if $easy_content|@count > 0}
    ...
    <section id="easycontent_{$ec.id_st_easy_content}" class="{if $ec.hide_on_mobile == 1} hidden-md-down {elseif $ec.hide_on_mobile == 2} hidden-lg-up {/if} easycontent {if !$ec.is_stacked_footer}col-lg-{if $ec.span}{$ec.span}{/if}{/if} footer_block block {if $ec.hide_on_mobile==4} st_open{/if}">
        {if $ec.title}
