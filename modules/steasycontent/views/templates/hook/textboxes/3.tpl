...
<div class="flex_container m-b-1">
	...
	<div class="flex_child">
		...
		{if isset($element.st_el_sub_header) && $element.st_el_sub_header}<div class="easy_sub_header">{$element.st_el_sub_header}</div>{/if}
	</div>
</div>
...
{if isset($element.st_el_url) && $element.st_el_url}<a href="{$element.st_el_url}" title="{if $element.st_el_button}{$element.st_el_button}{else}{l s='Read more' d='Shop.Theme.Panda'}{/if}" class="btn btn-link easy_link" rel="nofollow">{if $element.st_el_button}{$element.st_el_button}{else}{l s='Read more' d='Shop.Theme.Panda'}{/if}</a>{/if}