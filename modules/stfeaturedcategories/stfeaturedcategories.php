...
class StFeaturedCategories extends BaseSlider implements WidgetInterface
{
    ...
    protected function initTabNames()
    {
        $this->_tabs = array(
            ...
            array('id'  => '1,3', 'name' => $this->getTranslator()->trans('Homepage', array(), 'Admin.Theme.Panda')),
    ...
    public function initFieldsForm()
    {
        ...
        $fields['home_slider']['grid']['image_type'] = $this->getTranslator()->trans('Image type:', array(), 'Admin.Theme.Panda');

        $fields['home_slider']['sub_nbr'] = array(
            'type' => 'text',
            'label' => $this->getTranslator()->trans('The number of subcategories in Grid view:', array(), 'Admin.Theme.Panda'),
            'name' => 'sub_nbr',
            'default_value' => 5,
            'validation' => 'isUnsignedInt',
            'class' => 'fixed-width-sm',
            'desc' => $this->getTranslator()->trans('Set to 0 to not showing subcategories:', array(), 'Admin.Theme.Panda'),
        );
    ...
    private function _prepareHook($location= null)
    {
        ...
        if($rewind_nav && (int)Configuration::get($this->_prefix_stsn.'PRO_PER_FW')>count($featured_categories)){
                $rewind_nav=false;
            }
