...
<div class="alert alert-info" role="alert">
    ...
    <p class="alert-text">{l s='Click on one image below to set it as the hover image. The cover image is not showing on the list.' d='Admin.Theme.Panda'}</p>
</div>
<div id="product-images-container-sthoverimage" class="m-b-2">
    <div id="product-images-dropzone-sthoverimage" class="panel dropzone ui-sortable col-md-12 dz-started" data-max-size="8">
        ...
        <div class="dz-preview dz-image-preview">
            ...
            <div class="ishover{if !$image['hover']} hide{/if}">{l s='Hover' d='Admin.Theme.Panda'}</div>
        </div>
        {/foreach}
    </div>
</div>
