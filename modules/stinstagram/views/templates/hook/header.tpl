...
{if $stins_for_css && $stins_for_css|@count}
	...
	{if $stins_for_css && $stins_for_css|@count}
		...
		{strip}
			...
			{if $in['direction_color']} {$prefix} .swiper-button, {$prefix} .swiper-button{literal}{color:{/literal}{$in['direction_color']};} {/if} 
			{if $in['direction_color_hover']} {$prefix} .swiper-button:hover, {$prefix} .swiper-button:hover{literal}{color:{/literal}{$in['direction_color_hover']};} {/if} 
			{if $in['direction_color_disabled']} {$prefix} .swiper-button.disabled, {$prefix} .swiper-button.disabled:hover, {$prefix} .swiper-button.disabled, {$prefix} .swiper-button.disabled:hover{literal}{color:{/literal}{$in['direction_color_disabled']};} {/if} 
			{if $in['direction_bg']} {$prefix} .swiper-button, {$prefix} .swiper-button, {$prefix} .swiper-button{literal}{background-color:{/literal}{$in['direction_bg']};} {/if} 
			{if $in['direction_hover_bg']} {$prefix} .swiper-button:hover, {$prefix} .swiper-button:hover, instagram_block_center_container .swiper-button:hover{literal}{background-color:{/literal}{$in['direction_hover_bg']};} {/if} 
			{if $in['direction_disabled_bg']} {$prefix} .swiper-button.disabled,{$prefix} .swiper-button.disabled:hover, {$prefix} .swiper-button.disabled, {$prefix} .swiper-button.disabled,{$prefix} .swiper-button.disabled:hover, {$prefix} .swiper-button.disabled:hover{literal}{background-color:{/literal}{$in['direction_disabled_bg']};} {/if} 
			{if $in['pag_nav_bg']} {$prefix} .swiper-pagination span{literal}{background-color:{/literal}{$in['pag_nav_bg']};} {/if} 
			{if $in['pag_nav_bg_hover']} {$prefix}  .swiper-pagination.active span, {$prefix} .swiper-pagination:hover span{literal}{background-color:{/literal}{$in['pag_nav_bg_hover']};} {/if} 
