...
jQuery(function($){
    ...
    $('.st_delete_image').click(function(){
        ...
        var id = self.data('id');
        var mqv = self.data('mqv');
        $.getJSON(currentIndex+'&token='+token+'&configure=stowlcarousel&id_st_owl_carousel='+id+'&id_lang='+id_lang+'&mqv='+mqv+'&act=delete_image&ts='+new Date().getTime(),
            function(json){
                if(json.r) {
