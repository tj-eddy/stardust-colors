...
<div class="row mb-3">
    <div class="col-md-8">
        <div class="flex_container flex_start">
            <div class="mr-2">
              <img src="{if isset($product.cover.bySize.small_default.url)}{$product.cover.bySize.small_default.url}{/if}" {if $sttheme.google_rich_snippets} itemprop="image" {/if} width="{if isset($product.cover.bySize.small_default.width)}{$product.cover.bySize.small_default.width}{/if}" height="{if isset($product.cover.bySize.small_default.height)}{$product.cover.bySize.small_default.height}{/if}" alt="{if isset($product.cover.legend) && !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name}{/if}" class="general_border" />
            </div>
    ...
    <div class="col-md-4">
        <div class="mb-2 flex_box flex_left">
            ...
            <a href="{url entity='module' name='stproductcomments' controller='list' params=['id_product' => $product.id_product]}" title="{l s='View all reviews' d='Shop.Theme.Panda'}" class="mr-2">{$nbComments} {if $nbComments==1}{l s='Review' d='Shop.Theme.Panda'}{else}{l s='Reviews' d='Shop.Theme.Panda'}{/if}</a>
        </div>
