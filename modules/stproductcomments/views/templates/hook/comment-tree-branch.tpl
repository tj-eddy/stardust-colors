...
<div id="pcomment-{$node.id_st_product_comment}" class="line_item">
    <div class="flex_container flex_column_md flex_start px-2 pcomment-for-reply" {if $pcomments.g_rich_snippets} itemprop="review" itemscope itemtype="https://schema.org/Review"{/if}>
        <div class="pcomment_left">
            <div class="pcomment_author font-weight-bold pcomment_left_item" {if $pcomments.g_rich_snippets} itemprop="author" itemscope itemtype="https://schema.org/Person"{/if}><span{if $pcomments.g_rich_snippets} itemprop="name"{/if}>{$node.customer_name}</span></div>
        ...
        <div class="pcomment_right flex_child">
            ...
            <a href="{$image}" class="{if isset($pc_image_size)}pcomments_images_large{else}pcomments_images_small{/if} mr-2 mb-1 st_popup_image inline_block" title="{l s='Click to zoom out' d='Shop.Theme.Panda'}" rel="nofollow" data-group="pcomments_{$node.id_st_product_comment}"><img src="{$image}" class="general_border" alt="{l s='Click to zoom out' d='Shop.Theme.Panda'}" /></a>
            {/foreach}
            </div>
            {/if}
