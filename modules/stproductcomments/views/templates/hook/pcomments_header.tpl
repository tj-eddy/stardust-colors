...
<div class="pcomments_header mb-5">
    <div class="flex_box flex_left mb-3">
        ...
        <a href="{$pcomment_link}" title="{l s='View all reviews' d='Shop.Theme.Panda'}" class="mr-2">{$nbComments} {if $nbComments==1}{l s='Review' d='Shop.Theme.Panda'}{else}{l s='Reviews' d='Shop.Theme.Panda'}{/if}</a>
