    ...
    public function getFormFields()
    {
        ...
        $form_fields['home_slider'] = array(
            ...
            'pause_on_enter' => array(
                'type' => 'switch',
                'label' => $this->getTranslator()->trans('Pause on mouse enter:', array(), 'Admin.Theme.Transformer'),
                'name' => 'pause_on_enter',
                'default_value' => 0,
                'is_bool' => true,
                'values' => array(
            ...
            'reverse_direction' => array(
                'type' => 'switch',
                'label' => $this->getTranslator()->trans('Enables autoplay in reverse direction:', array(), 'Admin.Theme.Transformer'),
