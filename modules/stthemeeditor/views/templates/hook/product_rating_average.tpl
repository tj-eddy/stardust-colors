...
<div class="rating_box" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
	...
	{if isset($commentNbr) && $commentNbr}<span class="comment_nbr">{$commentNbr} {if $commentNbr>1}{l s='Reviews' d='Shop.Theme.Panda'}{else}{l s='Review' d='Shop.Theme.Panda'}{/if}</span>{/if}
</div>