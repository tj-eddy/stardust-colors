...
class StVideo extends Module implements WidgetInterface
{
	...
	{        
		...
		if (isset($_POST['save'.$this->name]) || isset($_POST['save'.$this->name.'AndStay']))
		{
            ...
            $video->id_products = '';
            $video->bo_title=Tools::getValue('bo_title');
			...
			if (!count($error) && $video->validateFields(false) && $video->validateFieldsLang(false))
            {
                ...
                if($video->save())
                {
                    ...
                    $video->restoreShopIds($assos_shop);
        ...
        if ($type == 0) {
            $array = array(
                array(
                    ...
                    'class' => 'fixed-width-xxl',
                    'required' => false,
                    'desc' => $this->getTranslator()->trans('For a reminder.', array(), 'Admin.Theme.Panda'),
				),
                array(
					'type' => 'text',
	...
	protected function initSizeChartList()
	{
		...
		$this->fields_list = array(
            ...
            'bo_title' => array(
				'title' => $this->getTranslator()->trans('Name', array(), 'Modules.Stvideo.Admin'),
				'width' => 120,
				'type' => 'text',
                'search' => false,
                'orderby' => false
    ...
    protected function initVideoList()
	{
		...
		$this->fields_list = array(
            ...
            'title' => array(
				'title' => $this->getTranslator()->trans('Title', array(), 'Modules.Stvideo.Admin'),
				'width' => 120,
				'type' => 'text',
                'search' => false,
                'orderby' => false
