...
<div id="viewed_top" class="top_bar_item dropdown_wrap">
	<div class="dropdown_tri dropdown_tri_in header_item" aria-haspopup="true" aria-expanded="false">
        <i class="fto-history icon_btn mar_r4"></i><span id="viewed_top_lable">{l s='Recently Viewed' d='Shop.Theme.Panda'}</span>{if $show_viewed_nbr}<span class="products_viewed_nbr amount_inline mar_l4">{if isset($viewed_products) && count($viewed_products)}{count($viewed_products)}{else}0{/if}</span>{/if}
