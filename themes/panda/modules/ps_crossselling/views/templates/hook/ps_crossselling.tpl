...
<section class="products_section" >
    ...
    <div class="block_content {if $sttheme.cs_lazy && !$sttheme.pro_tm_slider} lazy_swiper {/if}">
        ...
        scrollbar_nav=$sttheme.cs_scrollbar_nav
        }
    </div>
    ...
    spacing_between_fw=$sttheme.cs_spacing_between_fw
    spacing_between_xxl=$sttheme.cs_spacing_between_xxl
    spacing_between_xl=$sttheme.cs_spacing_between_xl
    spacing_between_lg=$sttheme.cs_spacing_between_lg
    spacing_between_md=$sttheme.cs_spacing_between_md
    spacing_between_sm=$sttheme.cs_spacing_between_sm
