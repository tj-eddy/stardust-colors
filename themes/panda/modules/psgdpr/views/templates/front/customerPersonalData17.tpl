...
<div class="container">
    <section class="page_content">
        <div class="col-xs-12 psgdprinfo17">
            <h3 class="page_heading">{l s='Access to my data' mod='psgdpr'}</h3>
            ...
            <a id="exportDataToCsv" class="btn btn-primary st_psgdprgetdatabtn17" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO CSV' mod='psgdpr'}</a>
            <a id="exportDataToPdf" class="btn btn-primary st_psgdprgetdatabtn17" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO PDF' mod='psgdpr'}</a>
        </div>
        <div class="col-xs-12 psgdprinfo17">
            <h3 class="page_heading">{l s='Rectification & Erasure requests' mod='psgdpr'}</h3>
