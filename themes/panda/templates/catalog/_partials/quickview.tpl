      ...
      <div class="row product_page_container">
        ...
        <div class="col-lg-{$sttheme.pro_image_column_md} mb-3">
          {block name='product_cover_thumbnails'}
            {include file='catalog/_partials/product-cover-thumbnails.tpl' from_quickview=1}
          {/block}
        </div>
            ...
            <div class="product-actions js-product-actions">
              <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                ...
                {block name='product_refresh'}
                  <input class="product-refresh js-product-refresh hidden" data-url-update="false" name="refresh" type="submit" value="{l s='Refresh' d='Shop.Theme.Actions'}" hidden>
                {/block}
            </form>
          </div>
        {/block}
