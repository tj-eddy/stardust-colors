                    ...
                    {if $nodes|count}
                        ...
                        <ul class="category-sub-menu category-sub-menu">
                            {foreach from=$nodes item=node}
                                <li  data-depth="{$depth}" class="{if $depth == 0}deph_one{/if}{/if}{if (isset($category) && is_array($category) && isset($category->id) && $category->id==$node.id) || (isset($id_category_current) && $id_category_current==$node.id)} current_cate {/if}">
          ...
          <div class="product-information">
            ...
            {if ($sttheme.display_pro_reference || (isset($steasybuilder) && $steasybuilder.is_editing)) && isset($product.reference_to_display)}
              <div class="product-reference pro_extra_info flex_container {if !$sttheme.display_pro_reference} display_none {/if}">
                ...
                <div class="paiementbloc"> <span class="cle">Paiement securisé avec :</span><img src="https://stardusthost.stardustcolors.com/themes/panda/assets/img/paiementaccepte.png" alt="logopaiement" loading="lazy"></div>
            {/if}
