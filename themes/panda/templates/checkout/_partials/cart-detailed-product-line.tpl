...
<div class="product-line-grid container-fluid">
  ...
  <div class="product-line-grid-left col-md-2 col-3">
    <span class="product-image media-middle">
      ...
      <!--[if IE 9]></video><![endif]-->
      {/if}
      <img src="{if isset($product.cover.bySize.cart_default.url) && $product.cover.bySize.cart_default.url}{$product.cover.bySize.cart_default.url}{elseif isset($urls.no_picture_image)}{$urls.no_picture_image.bySize.cart_default.url}{else}{$sttheme.img_prod_url}{$sttheme.lang_iso_code}-default-cart_default.jpg{/if}" width="{if isset($product.cover.bySize.cart_default.width)}{$product.cover.bySize.cart_default.width}{/if}" height="{if isset($product.cover.bySize.cart_default.height)}{$product.cover.bySize.cart_default.height}{/if}" alt="{$product.name|escape:'quotes'}" />
      </picture>
    </span>
  </div>
