...
{if !$sttheme.cms_title || (isset($steasybuilder) && $steasybuilder.is_editing)}
<h1 class="page_heading cms_page_heading {if $sttheme.cms_title} display_none {/if}">{$cms.meta_title}</h1>
{/if}
{/block}
