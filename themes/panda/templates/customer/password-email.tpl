...
{block name='page_content'}
  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <footer class="form-footer flex_container flex_left flex_column_md flex_start">
      <button class="form-control-submit btn btn-primary mb-3 mar_r6" name="submit" type="submit">
        {l s='Send reset link' d='Shop.Theme.Actions'}
      </button>
      <a href="{$urls.pages.my_account}" class="account-link btn btn-default mb-3">
